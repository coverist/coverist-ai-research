...
class CLIPTrainingModule(LightningModule):
    ...
    def forward(
        ...
        # Calculate the cross-entropy loss and accuracy. Note that the images and texts
        # are paired across batch axis, thus the labels should be an identity mapping.
